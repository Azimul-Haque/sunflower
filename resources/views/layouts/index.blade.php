...
<head>
    ...
    <meta name="msapplication-TileColor" content="#7EBD4F">
    <meta name="msapplication-TileImage" content="{{ asset('images/favicons/ms-icon-144x144.png') }}">
    <meta name="theme-color" content="#7EBD4F">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="single-widget about">
                            <div class="logo"><a href="/"><img src="/images/logo2.png" alt="Narsingdi BIAM Logo with Text" style="width:220px; height: auto;"></a></div>
