    			...
    			<div class="col-lg-5 offset-lg-6 col-12">
    				<div class="cta-inner overlay">
    					<div class="text-content">
    						...
    						<div class="button">
    							<a class="btn primary wow fadeInUp" href="admission" >Admission Info</a>
    						</div>
    					</div>
    				</div>
    			</div>
    		...
    		<div class="row">
    			<div class="col-12 wow zoomIn">
    				<div class="section-title">
    					...
    					<p>At <b>Narsingdi BIAM Zilla School & College</b>, our teachers are the heart of our success. Highly qualified, dedicated, and passionate, they go beyond teaching to inspire, mentor, and shape young minds, fostering excellence in academics and values.</p>
    				</div>
    			</div>
    		</div>
    				...
    				<div class="testimonial-slider">
                        ...
                        <div class="single-testimonial">
                            ...
                            <div class="main-content">
                                ...
                                <span class="name">{{ $testimonial->designation }}</span><br/><br/>
