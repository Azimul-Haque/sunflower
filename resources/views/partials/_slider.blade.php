...
<section class="home-slider">
    <div class="slider-active">
        <!-- Single Slider -->
        <div class="single-slider overlay" style="background-image:url('vendor/learnedu/images/slider/slider-bg1.jpg')">
            <div class="container">
                <div class="row">
        ...
        <!--/ End Single Slider -->
        <!-- Single Slider -->
        <div class="single-slider overlay" style="background-image:url('vendor/learnedu/images/slider/slider-bg2.jpg')">
            <div class="container">
                <div class="row">
        ...
        <!--/ End Single Slider -->
        <!-- Single Slider -->
        <div class="single-slider overlay" style="background-image:url('vendor/learnedu/images/slider/slider-bg3.jpg')">
            <div class="container">
                <div class="row">
