        ...
        <div class="box box-success">
          ...
          <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  {!! Form::textarea('message', null, array('class' => 'form-control text-green textarea', 'placeholder' => 'প্রশংসাবাক্য', 'required' => '', 'data-parsley-required-message' => 'প্রশংসাবাক্য আবশ্যক')) !!}
                </div>
            ...
            <div class="box-body">
              <table class="table">
                ...
                <tr>
                  ...
                  <td width="45%">{{ $testimonial->message }}</td>
                  <td>
                  ...
                  <div class="modal-dialog modal-md">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        {!! Form::model($testimonial, ['route' => ['dashboard.testimonials.delete', $testimonial->id], 'method' => 'DELETE', 'class' => 'form-default', 'enctype' => 'multipart/form-data']) !!}
